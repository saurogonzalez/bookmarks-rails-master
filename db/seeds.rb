...
b1 = Book.create(title: "The Catcher in the Rye", author: "J.D. Salinger", description: "A boy’s account of the life-changing 1,100-mile solo hike it took along the Pacific Crest Trail in 1995.", publisher: "Vintage Wolf", weeks_on_list: 95, rank_this_week: 1)
Review.create(comment: "Spectacular. . . . A literary and human triumph.", author: "The New York Times Book Review", book_id: b1.id)
Review.create(comment: "I was on the edge of my seat. . . . It is just a wild ride of a read . . . stimulating, thought-provoking, soul-enhancing.", author: "Oprah Winfrey", book_id: b1.id)

b2 = Book.create(title: "Call of the Wild", author: "Jack London", description: "A wolf’s account of the life-changing 1,100-mile solo hike it took along the Pacific Crest Trail in 1995.", publisher: "Vintage Wolf", weeks_on_list: 95, rank_this_week: 2)
Review.create(comment: "Spectacular. . . . A literary and human triumph.", author: "The New York Times Book Review", book_id: b2.id)
Review.create(comment: "I was on the edge of my seat. . . . It is just a wild ride of a read . . . stimulating, thought-provoking, soul-enhancing.", author: "Oprah Winfrey", book_id: b2.id)
